...
SOURCE = np.array([[712, 247], [1129, 258], [1442, 415], [384, 387]])
        ...
        for frame_idx, frame in enumerate(frame_generator):
            ...
            if speeding:
                screenshot_path = os.path.join(
                    args.screenshot_dir, f"frame_{frame_idx:06d}.jpg"
                )
...
#
# model = get_roboflow_model("yolov8x.pt")
# frame_generator = sv.get_video_frames_generator(r"C:\Users\admin\Desktop\New folder\vehicles.mp4")
